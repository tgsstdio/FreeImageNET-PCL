...
namespace FreeImageAPI
{
	...
	public struct FIURational : IComparable, IFormattable, IComparable<FIURational>, IEquatable<FIURational>
	{
		...
		public string ToString(string format, IFormatProvider formatProvider)
		{
			...
			return String.Format(formatProvider, format, ((double) this));
		}
